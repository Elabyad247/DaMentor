...
<head>
    ...
    <title>DaMentor - Introduction to IS</title>
...
<h2 style="color: white; text-align: center">Introduction to IS</h2>
<div class="courses">

    <?php
        $levelid = -1;
        $levels_query = mysqli_query($GLOBALS["conn"],"select * from levels where subCode = 'IS'") or die(mysqli_error($GLOBALS["conn"]));
        $tempid = 1;
