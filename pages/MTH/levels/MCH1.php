...
<h2 style="color: white; text-align: center">Chapter 1</h2>
<div class="courses">

    <?php
    $lectureid = -1;
        $lecture_query = mysqli_query($GLOBALS["conn"],"select * from lectures where levelCode = 'MCH1'") or die(mysqli_error($GLOBALS["conn"]));
    $_SESSION['levelCode'] = 'MCH1';
    $tempid = 1;
