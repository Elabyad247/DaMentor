...
<head>
    ...
    <title>DaMentor - Mathematics 2</title>
...
<h2 style="color: white; text-align: center">Mathematics 2</h2>
<div class="courses">

    <?php
        $levelid = -1;
        $levels_query = mysqli_query($GLOBALS["conn"],"select * from levels where subCode = 'MTH'") or die(mysqli_error($GLOBALS["conn"]));
        $tempid = 1;
