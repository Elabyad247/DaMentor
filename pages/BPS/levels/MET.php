...
?>
    ...
    <h2 style="color: white; text-align: center">MET Academy Videos</h2>
    <div class="courses">

        <?php
        $lectureid = -1;
        $lecture_query = mysqli_query($GLOBALS["conn"],"select * from lectures where levelCode = 'MET'") or die(mysqli_error($GLOBALS["conn"]));
        $_SESSION['levelCode'] = 'MET';
