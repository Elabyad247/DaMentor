...
<head>
    ...
    <title>DaMentor - Basic Problem Solving</title>
...
<header>
    <div class="topnav" id="myTopnav">
        ...
        <a href="../useful.php">Useful Stuff</a>
...
<h2 style="color: white; text-align: center">Basic Problem Solving</h2>
<div class="courses">

    <?php
        $levelid = -1;
        $levels_query = mysqli_query($GLOBALS["conn"],"select * from levels where subCode = 'BPS'") or die(mysqli_error($GLOBALS["conn"]));
    ...
    ?>
        ...
        <div class="card" id="<?php echo $row['levelCode']; ?>" onclick="changepadge('../levels/<?php echo $row['levelCode']; ?>.php')">
            ...
            <div class="container">
                <h4><b><?php echo $row['levelTitle']; ?></b></h4>
