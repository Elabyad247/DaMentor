...
<head>
    ...
    <title>DaMentor - Fundamentals of Management</title>
...
<h2 style="color: white; text-align: center">Fundamentals of Management</h2>
<div class="courses">

    <?php
        $levelid = -1;
        $levels_query = mysqli_query($GLOBALS["conn"],"select * from levels where subCode = 'FoM'") or die(mysqli_error($GLOBALS["conn"]));
        $tempid = 1;
