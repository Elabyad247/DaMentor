...
<head>
    ...
    <title>DaMentor - Programming Core</title>
...
<h2 style="color: white; text-align: center">Programming Core</h2>
<div class="courses">

    <?php
        $levelid = -1;
        $levels_query = mysqli_query($GLOBALS["conn"],"select * from levels where subCode = 'PC'") or die(mysqli_error($GLOBALS["conn"]));
    ...
    ?>
        ...
        <div class="card" id="<?php echo $row['levelCode']; ?>" onclick="changepadge('../levels/<?php echo $row['levelCode']; ?>.php')">
            <img src="../../assets/<?php echo $row['levelCode'] ?>.jpg" alt="Avatar" style="width: 100%" />
            <div class="container">
