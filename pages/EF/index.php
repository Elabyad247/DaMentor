...
<head>
    ...
    <title>DaMentor - Electronics Fundamentals</title>
...
<h2 style="color: white; text-align: center">Electronics Fundamentals</h2>
<div class="courses">

    <?php
        $levelid = -1;
        $levels_query = mysqli_query($GLOBALS["conn"],"select * from levels where subCode = 'EF'") or die(mysqli_error($GLOBALS["conn"]));
