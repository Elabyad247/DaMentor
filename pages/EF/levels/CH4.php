...
<h2 style="color: white; text-align: center">Chapter 4</h2>
<div class="courses">

    <?php
    $lectureid = -1;
        $lecture_query = mysqli_query($GLOBALS["conn"],"select * from lectures where levelCode = 'CH4'") or die(mysqli_error($GLOBALS["conn"]));
    $_SESSION['levelCode'] = 'CH4';
    $tempid = 1;
