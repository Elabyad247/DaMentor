...
<h2 style="color: white; text-align: center">Chapter 0</h2>
<div class="courses">

    <?php
    $lectureid = -1;
        $lecture_query = mysqli_query($GLOBALS["conn"],"select * from lectures where levelCode = 'CH0'") or die(mysqli_error($GLOBALS["conn"]));
    $_SESSION['levelCode'] = 'CH0';
    $tempid = 1;
