...
<head>
    ...
    <title>DaMentor - Advanced Problem Solving</title>
...
<h2 style="color: white; text-align: center">Advanced Problem Solving</h2>
<div class="courses">

    <?php
        $levelid = -1;
        $levels_query = mysqli_query($GLOBALS["conn"],"select * from levels where subCode = 'APS'") or die(mysqli_error($GLOBALS["conn"]));
