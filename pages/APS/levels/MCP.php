...
<h2 style="color: white; text-align: center">Math</h2>
<div class="courses">

    <?php
    $lectureid = -1;
        $lecture_query = mysqli_query($GLOBALS["conn"],"select * from lectures where levelCode = 'MCP'") or die(mysqli_error($GLOBALS["conn"]));
    $_SESSION['levelCode'] = 'MCP';
