...
<h2 style="color: white; text-align: center">ICPC - Thinking Techniques</h2>
<div class="courses">

    <?php
    $lectureid = -1;
        $lecture_query = mysqli_query($GLOBALS["conn"],"select * from lectures where levelCode = 'CPIT'") or die(mysqli_error($GLOBALS["conn"]));
    $_SESSION['levelCode'] = 'CPIT';
    $tempid = 1;
