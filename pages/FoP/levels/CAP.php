...
<h2 style="color: white; text-align: center">Computer and Programming</h2>
<div class="courses">

    <?php
    $lectureid = -1;
        $lecture_query = mysqli_query($GLOBALS["conn"],"select * from lectures where levelCode = 'CAP'") or die(mysqli_error($GLOBALS["conn"]));
    $_SESSION['levelCode'] = 'CAP';
    $tempid = 1;
