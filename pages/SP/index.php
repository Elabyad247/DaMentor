...
<h2 style="color: white; text-align: center">Statistics & Probabilities</h2>
<div class="courses">

    <?php
        $levelid = -1;
        $levels_query = mysqli_query($GLOBALS["conn"],"select * from levels where subCode = 'SP'") or die(mysqli_error($GLOBALS["conn"]));
        $tempid = 1;
